...
class MinimumChangesToMakeAlternatingBinaryString {
    private static int minOperations(String s) {
        ...
        return Math.min(cnt1, s.length() - cnt1);
    }
    public static void main(String[] args) {
        Log.info(minOperations("0100"));     // 1
        Log.info(minOperations("10"));       // 0
        Log.info(minOperations("1111"));     // 2
        Log.info(minOperations("10010100")); // 3
    }
}
/**
    private static int minOperations(String s) {
