...
class ShortestDistanceToTargetStringInACircularArray {
    ...
    public static void main(String[] args) {
        Log.info(closestTarget(new String[] {"hello","i","am","leetcode","hello"}, "hello", 1)); // 1
        Log.info(closestTarget(new String[] {"a","b","leetcode"}, "leetcode", 0));               // 1
        Log.info(closestTarget(new String[] {"i","eat","leetcode"}, "ate", 0));                  // -1
    }
}
/**
    private static int closestTarget(String[] words, String target, int startIndex) {
