/**
   ...
   1 <= k <= 100
*/
class MinOpsToMakeArrSumDivisibleByK {
    ...
    public static void main(String[]args) {
        IO.println(minOperations(new int[]{3, 9, 7}, 5));
        IO.println(minOperations(new int[]{4, 1, 3}, 4));
        IO.println(minOperations(new int[]{3, 2}, 6));
    }
}
