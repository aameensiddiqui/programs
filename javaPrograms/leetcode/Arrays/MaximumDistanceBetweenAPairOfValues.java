...
class MaximumDistanceBetweenAPairOfValues {
    ...
    public static void main(String[] args) {
        Log.info(maxDistance(new int[] {55,30,5,4,2}, new int[] {100,20,10,10,5}));
        Log.info(maxDistance(new int[] {2,2,2}, new int[] {10,10,1}));
        Log.info(maxDistance(new int[] {30,29,19,5}, new int[] {25,25,25,25,25}));
    }
}
