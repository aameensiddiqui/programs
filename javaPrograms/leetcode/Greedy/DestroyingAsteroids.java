/**
   ...
   asteroid is destroyed and the planet gains the mass of the asteroid. Otherwise, the planet is destroyed.
...
class DestroyingAsteroids {
    ...
    public static void main(String[] args) {
        Log.info(asteroidsDestroyed(10, new int[] {3,9,19,5,21}));
        Log.info(asteroidsDestroyed(5, new int[] {4,9,23,4}));
    }
}
