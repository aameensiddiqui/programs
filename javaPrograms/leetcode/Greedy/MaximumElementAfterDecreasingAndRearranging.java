...
class MaximumElementAfterDecreasingAndRearranging {
    ...
    public static void main(String[] args) {
        Log.info(maximumElementAfterDecrementingAndRearranging(new int[] {2,2,1,2,1}));
        Log.info(maximumElementAfterDecrementingAndRearranging(new int[] {100,1,1000}));
        Log.info(maximumElementAfterDecrementingAndRearranging(new int[] {1,2,3,4,5}));
    }
}
