...
class MinimumInitialEnergyToFinishTasks {
    ...
    public static void main(String[] args) {
        Log.info(minimumEffort(new int[][] {{1,2},{2,4},{4,8}}));
        Log.info(minimumEffort(new int[][] {{1,3},{2,4},{10,11},{10,12},{8,9}}));
        Log.info(minimumEffort(new int[][] {{1,7},{2,8},{3,9},{4,10},{5,11},{6,12}}));
    }
}
