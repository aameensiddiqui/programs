/**
   ...
   Given a 0-indexed integer array cost, where cost[i] denotes the cost of the ith candy, return
   the minimum cost of buying all the candies.
...
class MinimumCostOfBuyingCandiesWithDiscount {
    ...
    public static void main(String[] args) {
        Log.info(minimumCost(new int[] {1,2,3}));
        Log.info(minimumCost(new int[] {6,5,7,9,2,2}));
        Log.info(minimumCost(new int[] {5,5}));
    }
}
