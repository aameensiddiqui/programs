/**
   ...
   A block cannot be placed if it intersects with any obstacle, but it may touch it. Note that you do
...
class BlockPlacementQueries {
    ...
    public static void main(String[] args) {
        Log.info(getResults(new int[][] {{1,2},{2,3,3},{2,3,1},{2,2,2}}));
        Log.info(getResults(new int[][] {{1,7},{2,7,6},{1,2},{2,7,5},{2,7,6}}));
    }
}
