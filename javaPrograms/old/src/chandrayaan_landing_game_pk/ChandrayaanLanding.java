package chandrayaan_landing_game_pk;

import java.util.Scanner;
class ChandrayaanLanding{
    public static void main(String[]args){
        ...
        System.out.println("TIME\t\tALTITUDE\t\tVELOCITY\t\tFUEL\t\tFUEL RATE");
        
         while(altitude >= 0 && fuel >= 0){
        	 System.out.print("enter fuel rate");
        	 fuel_rate = scan.nextInt();
        	 System.out.println(time+"\t\t"+altitude+"\t\t"+velocity+"\t\t"+fuel+"\t\t"+fuel_rate);
        	 time = time + 10;
